...
class SageLiveAccount extends SageLiveSObject
{
    ...
    protected $fields   = [
        ...
        "BillingCity"                           => ["required" => false, "type" => "Text(120)"],
        "BillingCountry"                        => ["required" => false, "type" => "Text(120)"],
        "BillingGeocodeAccuracy"                => ["required" => false, "type" => "Text(120)"],
        "BillingLatitude"                       => ["required" => false, "type" => "Text(120)"],
        "BillingLongitude"                      => ["required" => false, "type" => "Text(120)"],
        "BillingPostalCode"                     => ["required" => false, "type" => "Text(120)"],
        "BillingState"                          => ["required" => false, "type" => "Text(120)"],
        "BillingStreet"                         => ["required" => false, "type" => "Text(120)"],
        ...
        "ShippingCity"                          => ["required" => false, "type" => "Text(120)"],
        "ShippingCountry"                       => ["required" => false, "type" => "Text(120)"],
        "ShippingGeocodeAccuracy"               => ["required" => false, "type" => "Text(120)"],
        "ShippingLatitude"                      => ["required" => false, "type" => "Text(120)"],
        "ShippingLongitude"                     => ["required" => false, "type" => "Text(120)"],
        "ShippingPostalCode"                    => ["required" => false, "type" => "Text(120)"],
        "ShippingState"                         => ["required" => false, "type" => "Text(120)"],
        "ShippingStreet"                        => ["required" => false, "type" => "Text(120)"],
